...
public class GroupScreen : GenericScreen 
{
	...
	private void RequestGroupInfo ()
	{
		...
		if (infoRequest.responseHeaders["STATUS"] == "HTTP/1.1 200 OK")
		{
	...
	private void ProcessAdding(WWW addRequest)
	{
		...
		if (addRequest.responseHeaders["STATUS"] == "HTTP/1.1 200 OK") 
		{
	...
	private void ProcessDelete(WWW removeRequest)
	{
		...
		if (removeRequest.responseHeaders["STATUS"] == "HTTP/1.1 200 OK") 
		{
